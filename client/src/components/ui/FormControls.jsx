export const Card = ({ className = '', children }) => (
  <section className={`rounded-2xl border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)] ${className}`}>{children}</section>
);
...
export const Input = forwardRef(function Input({ className = '', ...props }, ref) {
  return <input ref={ref} className={`w-full rounded-xl border border-slate-200 bg-white px-3.5 py-3 text-sm text-slate-800 outline-none transition duration-300 placeholder:text-slate-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-100 ${className}`} {...props} />;
});
