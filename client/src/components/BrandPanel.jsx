  ...
  <aside className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 px-6 py-8 text-white sm:px-10 lg:flex lg:w-3/5 lg:flex-col lg:px-12 lg:py-12">
    ...
    <div className="relative mx-auto flex w-full max-w-2xl flex-col lg:h-full">
      ...
      <div className="my-10 lg:my-auto">
        <div className="relative mb-8 overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.35)] backdrop-blur-xl sm:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-3xl border border-white/10 bg-slate-950/35 p-5">
              ...
              <div className="grid gap-3">
                <div className="h-3 rounded-full bg-white/10"><div className="h-3 w-3/4 rounded-full bg-gradient-to-r from-sky-400 to-indigo-400" /></div>
                <div className="h-3 rounded-full bg-white/10"><div className="h-3 w-2/3 rounded-full bg-gradient-to-r from-indigo-400 to-cyan-300" /></div>
                <div className="h-3 rounded-full bg-white/10"><div className="h-3 w-5/6 rounded-full bg-gradient-to-r from-blue-400 to-emerald-300" /></div>
              </div>
            </div>
            <div className="grid gap-3">
              <div className="rounded-3xl border border-white/10 bg-slate-950/35 p-4 text-center"><p className="text-[11px] uppercase tracking-[0.2em] text-slate-400">Trips</p><p className="mt-2 text-2xl font-bold">128</p></div>
              <div className="rounded-3xl border border-white/10 bg-slate-950/35 p-4 text-center"><p className="text-[11px] uppercase tracking-[0.2em] text-slate-400">Uptime</p><p className="mt-2 text-2xl font-bold">99.9%</p></div>
            </div>
          </div>
          <div className="mt-5 flex items-center justify-between rounded-3xl border border-white/10 bg-slate-950/35 px-4 py-3">
            <div><p className="text-xs text-slate-400">Command Center</p><p className="text-sm font-semibold text-white">Dispatch, compliance, and finance in one view</p></div>
      ...
      <p className="mt-8 text-xs text-slate-500">TransitOps © 2026</p>
    </div>
  </aside>
);
