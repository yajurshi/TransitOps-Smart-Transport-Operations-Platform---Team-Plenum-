...
export const RecentTripsTable = ({ trips }) => {
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'Draft':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
