      ...
      <div className="border-b border-slate-200 pb-4 flex justify-between items-center">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-5 flex flex-col items-center text-center">
              {/* Profile Avatar */}
              ...
              <div>
                <h3 className="font-bold text-slate-800 text-lg leading-tight">Alex Mercer</h3>
              ...
              <div className="w-full pt-4 border-t border-slate-100 space-y-3 text-left">
                <div>
                  ...
                  <span className="text-xs font-semibold text-slate-700 block mt-0.5">alex.mercer@transitops.com</span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Mobile Phone</span>
                  <span className="text-xs font-semibold text-slate-700 block mt-0.5">+1 555-019-382</span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Security Department</span>
                  <span className="text-xs font-semibold text-slate-700 block mt-0.5">Logistics & Route Dispatch</span>
                </div>
              </div>
            ...
            <div className="md:col-span-2 bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
              <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
                ...
                <h3 className="font-bold text-slate-800 text-sm uppercase tracking-wider">Change Password Security</h3>
              </div>
