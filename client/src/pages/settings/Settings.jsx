          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-5 shadow-sm space-y-5">
                ...
                <div className="space-y-4">
                  <div>
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider block">Central Depot Address</span>
                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 block mt-1">100 Logistics Pkwy, Chicago, IL</span>
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider block">Default Currency</span>
                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 block mt-1">USD ($)</span>
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider block">Distance Metric Unit</span>
                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 block mt-1">Kilometers (km)</span>
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider block">Support Contact Email</span>
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-5 shadow-sm space-y-5">
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all hover:bg-slate-50 dark:hover:bg-slate-700 dark:bg-slate-900 border-slate-200 dark:border-slate-700">
                    <input 
                      type="radio" 
                      name="theme" 
                      value="light" 
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500">Default high contrast view</span>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all hover:bg-slate-50 dark:hover:bg-slate-700 dark:bg-slate-900 border-slate-200 dark:border-slate-700">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500">Low-glare optimized for nighttime</span>
                    </div>
                  </label>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-5 shadow-sm space-y-4">
              <div>
                ...
                <p className="text-[11px] text-slate-400 dark:text-slate-500 font-medium">RBAC configurations are read-only for security reasons.</p>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700">
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Module / Asset</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Fleet Manager</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Dispatcher</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Safety Officer</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">Financial Analyst</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100">
                    {rbacMatrix.map((row, idx) =>
                    <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-700 dark:bg-slate-900/50">
