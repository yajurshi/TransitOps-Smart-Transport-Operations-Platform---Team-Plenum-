    ...
    <SafetyOfficerPageShell activeTab="Drivers" title={`${driver.name} Details`} subtitle="Compliance profile and readiness summary.">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <SectionCard title="Identity & Details" subtitle="Can edit">
          <form className="space-y-4 text-sm text-slate-600 dark:text-slate-300">
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wide">Contact Number</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wide">License Number</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wide">License Category</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wide">License Expiry</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wide">Safety Score</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wide">Status</label>
        ...
        <SectionCard title="Document Uploads" subtitle="Can upload">
          <div className="space-y-4">
            <div className="border border-dashed border-slate-300 rounded-lg p-4 text-center hover:bg-slate-50 dark:hover:bg-slate-700 dark:bg-slate-900 transition">
              <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">Driving License</p>
              <button className="mt-2 text-xs bg-slate-200 hover:bg-slate-300 text-slate-700 dark:text-slate-200 font-bold py-1 px-3 rounded">Upload PDF/Image</button>
            </div>
            <div className="border border-dashed border-slate-300 rounded-lg p-4 text-center hover:bg-slate-50 dark:hover:bg-slate-700 dark:bg-slate-900 transition">
              <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">Medical Certificate <span className="text-[10px] text-green-600 bg-green-100 px-1 rounded ml-1">Bonus</span></p>
              <button className="mt-2 text-xs bg-slate-200 hover:bg-slate-300 text-slate-700 dark:text-slate-200 font-bold py-1 px-3 rounded">Upload Document</button>
            </div>
            <div className="border border-dashed border-slate-300 rounded-lg p-4 text-center hover:bg-slate-50 dark:hover:bg-slate-700 dark:bg-slate-900 transition">
              <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">Driver Documents <span className="text-[10px] text-green-600 bg-green-100 px-1 rounded ml-1">Bonus</span></p>
              <button className="mt-2 text-xs bg-slate-200 hover:bg-slate-300 text-slate-700 dark:text-slate-200 font-bold py-1 px-3 rounded">Upload Additional Files</button>
            </div>
          </div>
        </SectionCard>
        ...
        <SectionCard title="Driver Compliance" subtitle="Separate compliance checks">
          <div className="space-y-4 text-sm text-slate-600 dark:text-slate-300">
            <p className="font-semibold text-slate-800 dark:text-white">Compliance Actions</p>
