...
export const Sidebar = ({ activeTab = 'Dashboard', role: propRole }) => {
  ...
  return (
    <div className="w-64 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 h-screen fixed left-0 top-0 flex flex-col border-r border-slate-200 dark:border-slate-700 z-30 shadow-sm">
      {/* Premium Logo Header */}
      ...
      <div className="p-4 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-400 dark:text-slate-500 flex flex-col gap-2 bg-slate-50 dark:bg-slate-900/50">
        ...
        <div className="flex justify-between items-center px-1 pt-1 border-t border-slate-200 dark:border-slate-700/50">
