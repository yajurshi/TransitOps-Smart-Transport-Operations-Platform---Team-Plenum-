...
export const FinancialDashboard = () => (
  <RolePageLayout activeTab="Analytics" title="Financial Dashboard" subtitle="Monitor operational expenses, profitability and fleet financial performance." showSearch={false}>
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><p className="text-sm text-slate-500">Financial overview · Updated today</p><ExportActions expenseRows={expenses} /></div>
